  ...
  return (
    <div className="privacy-policy">
      ...
      <div data-custom-class="body">
        ...
        <div><span style={{color: 'rgb(127, 127, 127)'}}><strong><span style={{fontSize: '15px'}}><span data-custom-class="subtitle">Last updated October 09, 2025</span></span></strong></span></div>
        <div><br /></div>
        <div><br /></div>
        <div><br /></div>
          ...
          <span style={{color: 'rgb(127, 127, 127)'}}>
            <span style={{color: 'rgb(89, 89, 89)', fontSize: '15px'}}>
              <span data-custom-class="body_text">
                This Privacy Notice for <strong>Rally Inc.</strong> (doing business as <strong>Rally</strong>) 
        ...
        <ul>
          <li data-custom-class="body_text" style={{lineHeight: '1.5'}}>
            <span style={{fontSize: '15px', color: 'rgb(89, 89, 89)'}}>
              <span data-custom-class="body_text">
                Download and use our mobile application (Rally), or any other application of ours that links to this Privacy Notice
              </span>
            </span>
          </li>
        </ul>
        ...
        <div style={{lineHeight: '1.5'}}>
          <span style={{fontSize: '15px'}}>
            <span style={{color: 'rgb(127, 127, 127)'}}>
              <span data-custom-class="body_text">
                <strong>Questions or concerns?</strong> Reading this Privacy Notice will help you understand your privacy rights and choices. We are responsible for making decisions about how your personal information is processed. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at <a target="_blank" data-custom-class="link" href="mailto:rally.soloq@gmail.com">rally.soloq@gmail.com</a>.
              </span>
            </span>
          </span>
        </div>
        ...
        <div style={{lineHeight: '1.5'}}>
          ...
          <a data-custom-class="link" href="https://app.termly.io/dsar/d1901a93-7f53-4a77-8d5d-b9cf8a3ee675" rel="noopener noreferrer" target="_blank">
            <span style={{color: 'rgb(0, 58, 250)', fontSize: '15px'}}>
        ...
        <div style={{lineHeight: '1.5'}}>
          <span style={{fontSize: '15px'}}>
            <a data-custom-class="link" href="#whoshare">
              <span style={{color: 'rgb(0, 58, 250)'}}>4. WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?</span>
            </a>
          </span>
        </div>
        ...
        <div style={{lineHeight: '1.5'}}>
          <span style={{fontSize: '15px'}}>
            <a data-custom-class="link" href="#privacyrights">
              <span style={{color: 'rgb(0, 58, 250)'}}>10. WHAT ARE YOUR PRIVACY RIGHTS?</span>
            </a>
          </span>
        </div>
        ...
        <div style={{lineHeight: '1.5'}}>
          <a data-custom-class="link" href="#contact">
            <span style={{color: 'rgb(0, 58, 250)', fontSize: '15px'}}>14. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</span>
          </a>
        </div>
        
        <div style={{lineHeight: '1.5'}}>
          <a data-custom-class="link" href="#request">
            <span style={{color: 'rgb(0, 58, 250)'}}>15. HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?</span>
          </a>
        </div>
        ...
        <div style={{lineHeight: '1.5'}}>
          <p style={{textAlign: 'center', fontSize: '14px', marginTop: '30px', opacity: '0.65', fontFamily: 'sans-serif'}}>
            Powered by <a href="https://www.froala.com/wysiwyg-editor?pb=1" title="Froala Editor">Froala Editor</a>
          </p>
        </div>
      </div>
    </div>
